...
MY_COMMANDERS_Y2_ID = os.getenv("MY_COMMANDERS_Y2_GROUP_ID")
...
PERM_DUTY_CMDS = [os.getenv("ZEYEUNG_NUMBER"), 
                  ...
                  os.getenv("SOLAI_NUMBER"),
                  os.getenv("RYAN_NUMER"),
                  os.getenv("HUDA_NUMBER"),
                  os.getenv("CALEB_NUMBER"),
                  os.getenv("REX_NUMBER")]
